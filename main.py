...
def new_card():
    ...
    canvas.itemconfig(side_of_card, image=front_card_image)
    flip_timer = window.after(3000, func=flip_card)


def flip_card():
    global current_card
    canvas.itemconfig(side_of_card, image=back_card_image)
...
side_of_card = canvas.create_image(400, 263, image=front_card_image)
